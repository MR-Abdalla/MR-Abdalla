        ...
        if (user) {
            try {
                ...
                if (docSnap.exists) {
                    ...
                    window.location.href = "https://mr-abdalla.pages.dev/login/index.html";
                }
            } catch (error) {
...
function displayStudentData(data) {
    ...
    if (data.grade === 'اولي ثانوي') {
        platformBtn.addEventListener('click', () => window.location.href = "https://mr-abdalla.pages.dev/Year-1/index.html");
    } else if (data.grade === 'تنيا ثانوي') {
        platformBtn.addEventListener('click', () => window.location.href = "https://mr-abdalla.pages.dev/Year-2/index.html");
    } else if (data.grade === 'تلتا ثانوي') {
        platformBtn.addEventListener('click', () => window.location.href = "https://mr-abdalla.pages.dev/Year-3/index.html");
    }
}
